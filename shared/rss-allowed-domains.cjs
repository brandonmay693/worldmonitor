// Canonical list of allowed RSS feed domains.
// Consumed by: scripts/ais-relay.cjs, api/rss-proxy.js
// When adding new domains, add them here — single source of truth.
module.exports = [
  'feeds.bbci.co.uk',
  'www.theguardian.com',
  'feeds.npr.org',
